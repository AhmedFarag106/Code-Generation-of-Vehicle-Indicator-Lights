...
## Generated on : Sun Jul 14 19:12:26 2024
## Final product: ./controller.exe
...
MAKEFILE                  = controller.mk
MATLAB_ROOT               = F:/progs/matlab_2022
MATLAB_BIN                = F:/progs/matlab_2022/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = F:/MBD/projects/mini_project1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
MODELREF_LINK_RSPFILE     = controller_ref.rsp
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/controller_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/controller_ert_rtw/sil -I$(START_DIR)/controller_ert_rtw/coderassumptions -I$(MATLAB_ROOT)/toolbox/rtw/targets/pil/c -I$(MATLAB_ROOT)/extern/include/coder/connectivity/XILTgtAppSvc -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/extern/include/coder/connectivity/CoderAssumpTgtAppSvc
...
MODELREF_LIBS = ../controller.obj

LIBS = $(START_DIR)/controller_ert_rtw/coderassumptions/lib/controller_ca.lib $(MATLAB_ROOT)/sys/lcc64/lcc64/lib64/wsock32.lib
...
xil_interface.obj : $(START_DIR)/controller_ert_rtw/sil/xil_interface.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")


sil_main.obj : $(START_DIR)/controller_ert_rtw/sil/sil_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
